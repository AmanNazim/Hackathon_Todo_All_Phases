...
const FeedbackMessage: React.FC<FeedbackMessageProps> = ({
  ...
  }, [message, type, autoClose, autoCloseDuration, onClose]);
  ...
  const typeStyles = {
    ...
    error: {
      bg: 'bg-cinnabar-50 dark:bg-cinnabar-900/20',
      border: 'border-cinnabar-200 dark:border-cinnabar-800',
      text: 'text-cinnabar-800 dark:text-cinnabar-200',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
          <path
            fillRule="evenodd"
